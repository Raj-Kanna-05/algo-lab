  ...
  return (
    <div className="container" style={{ paddingTop: 32, paddingBottom: 80 }}>
      ...
      <div style={styles.headerRow}>
        ...
        <button style={styles.newMazeBtn} onClick={handleNewMaze} id="astar-new-maze">
          New Maze 🎲
        </button>
      </div>
      ...
      <p style={styles.description}>
        ...
        to the goal</em> using Manhattan distance heuristic.
      </p>

      <div style={styles.legend}>
        <LegendItem color="var(--marker-blue)"  label="Start (S)" />
        <LegendItem color="var(--marker-green)" label="Goal (E)" />
        <LegendItem color="var(--marker-amber)" label="Open set" />
        <LegendItem color="var(--tint-blue)"    label="Closed" />
